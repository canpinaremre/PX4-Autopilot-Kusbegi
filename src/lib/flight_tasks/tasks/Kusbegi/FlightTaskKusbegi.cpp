...
void FlightTaskKusbegi::_publishVehicleCmdDoLand()
{
...
bool FlightTaskKusbegi::activate(const vehicle_local_position_setpoint_s &last_setpoint)
{
	...
	//mavlink_log_critical(&mavlink_log_pub, "KUSBEGIIIIII");
...
bool FlightTaskKusbegi::update()
{
	...
	//Kusbegi 2 metreye manuel yada qgc tarafından çıakrılıcak sonrasında parametre aktif edilecek.
